            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="users_edit.php">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                      <label for="edit_company" class="col-sm-3 control-label">Company Name</label>
...
<div class="modal fade" id="activate">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="submit" class="btn btn-danger btn-flat pull-left" name="decline"><i class="fa fa-close"></i> Disable</button>
