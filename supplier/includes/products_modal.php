...
<div class="modal fade" id="activate">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="product_activate.php">
                    <input type="hidden" class="prodid" name="id">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-danger btn-flat pull-left" name="disable"><i class="fa fa-close"></i> Disable</button>
