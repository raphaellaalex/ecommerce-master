...
$stmt1 = $conn->query("SELECT details.company_name as retailer,count(*) as number2 FROM products LEFT JOIN details ON products.id=details.product_id JOIN users ON details.supplier=users.company_name  WHERE users.id = $_SESSION[supplier] GROUP BY details.company_name");
...
<?php include 'includes/scripts.php'; ?>
    ...
    <script type="text/javascript">
        ...
        function drawChart1()
        {
            ...
            var options = {
                title: 'Percentage of each Product\'s Selection',
                //is3D:true,
                pieHole: 0.4,
